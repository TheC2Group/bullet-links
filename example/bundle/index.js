...
var createHTML = function createHTML() {
  ...
  for (var x = 0; x < this.count; x += 1) {
    items.push(jquery(generateMarkup.call(this, x))[0]);
  }
...
Bullets.prototype.appendTo = function (selector) {
  this.$parent = jquery(selector).append(this.$el);
  return this;
};
...
},{"../../cjs/bullet-links.js":1,"jquery":3}],3:[function(require,module,exports){
/*!
 * jQuery JavaScript Library v3.4.1
 * https://jquery.com/
 *
